              ...
              <React.Fragment key={pageIdx}>
                ...
                <div className="pdf-page pdf-page-table">
                  ...
                  <div className="pdf-legend">
                    ...
                    <span className="pdf-legend-item"><span className="pdf-legend-box pdf-cell-done"></span> On-Time (e.g. 1/1 (17))</span>
                    <span className="pdf-legend-item"><span className="pdf-legend-box pdf-cell-shifted-plan"></span> Shifted Plan (➔ Apr)</span>
                    <span className="pdf-legend-item"><span className="pdf-legend-box pdf-cell-shifted-actual"></span> Shifted Done (1/1 (17*))</span>
